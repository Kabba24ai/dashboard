        ...
        <div className="bg-white p-4 border border-gray-200 rounded-lg shadow-lg">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium">${sales.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
            </div>
            <div className="flex items-center justify-between">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="flex flex-wrap justify-center gap-4 max-w-5xl">
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 min-w-[168px] text-center">
                <div className="text-xs text-gray-600 font-medium mb-1">Total Sales</div>
                <div className="text-lg font-semibold text-purple-800 whitespace-nowrap">${categoryMetrics.totalSales.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
              </div>
              <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200 min-w-[168px] text-center">
                ...
                <div className="text-lg font-semibold text-indigo-800 whitespace-nowrap">${categoryMetrics.avgSales.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="flex justify-center mb-6">
            <div className="flex flex-wrap justify-center gap-4 max-w-5xl">
              <div className="bg-amber-50 p-4 rounded-lg border border-amber-200 min-w-[168px] text-center">
                <div className="text-xs text-gray-600 font-medium mb-1">Total Sales</div>
                <div className="text-lg font-semibold text-amber-800 whitespace-nowrap">${productMetrics.totalSales.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg border border-orange-200 min-w-[168px] text-center">
                ...
                <div className="text-lg font-semibold text-orange-800 whitespace-nowrap">${productMetrics.avgSales.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
              </div>
