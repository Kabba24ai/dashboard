...
import { Trophy, Truck, Store, RotateCcw, Wrench, AlertTriangle, Clock, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Sales Trend Analysis</h2>
          <PeriodSelector 
            value={salesPeriod} 
          ...
          <ResponsiveContainer width="100%" height={400}>
            <LineChart data={salesData[salesPeriod] || salesData.rolling30}>
